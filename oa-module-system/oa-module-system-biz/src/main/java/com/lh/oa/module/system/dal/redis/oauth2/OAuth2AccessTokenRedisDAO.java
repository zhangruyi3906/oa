package com.lh.oa.module.system.dal.redis.oauth2;
...
import static com.lh.oa.module.system.dal.redis.RedisKeyConstants.OAUTH2_ACCESS_TOKEN;
...
public class OAuth2AccessTokenRedisDAO {
    ...
    public void set(OAuth2AccessTokenDO accessTokenDO) {
        ...
        long time = LocalDateTimeUtil.between(LocalDateTime.now().minusMinutes(10), accessTokenDO.getExpiresTime(), ChronoUnit.SECONDS);
        if (time > 0) {
