package com.lh.oa.module.system.controller.admin.auth.vo;

import cn.hutool.core.text.CharSequenceUtil;
import com.lh.oa.framework.common.validation.InEnum;
import com.lh.oa.module.system.enums.social.SocialTypeEnum;
...
public class AuthLoginReqVO {
    ...
    public boolean isSocialCodeValid() {
        return socialType == null || CharSequenceUtil.isNotEmpty(socialCode);
    }

    @AssertTrue(message = "授权 state 不能为空")
    public boolean isSocialState() {
        return socialType == null || CharSequenceUtil.isNotEmpty(socialState);
    }
