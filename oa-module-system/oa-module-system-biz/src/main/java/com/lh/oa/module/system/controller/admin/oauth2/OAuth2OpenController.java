...
import com.lh.oa.framework.common.util.http.HttpUtils;
import com.lh.oa.framework.common.util.json.JsonUtils;
import com.lh.oa.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.lh.oa.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.lh.oa.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.lh.oa.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.lh.oa.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.lh.oa.module.system.service.oauth2.OAuth2ApproveService;
import com.lh.oa.module.system.service.oauth2.OAuth2ClientService;
import com.lh.oa.module.system.service.oauth2.OAuth2GrantService;
import com.lh.oa.module.system.service.oauth2.OAuth2TokenService;
import com.lh.oa.module.system.util.oauth2.OAuth2Utils;
...
import static com.lh.oa.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.lh.oa.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    //@Operation(enable = false) // 避免 Post 请求被记录操作日志
    ...
    public CommonResult<String> approveOrDeny(@RequestParam("response_type") String responseType,
        ...
        if (Boolean.TRUE.equals(autoApprove)) {
            ...
            if (!oauth2ApproveService.updateAfterApproval(userId, getUserType(), clientId, scopes)) {
        ...
        if (grantTypeEnum == OAuth2GrantTypeEnum.AUTHORIZATION_CODE) {
            return success(getAuthorizationCodeRedirect(userId, client, approveScopes, redirectUri, state));
        }
        return success(getImplicitGrantRedirect(userId, client, approveScopes, redirectUri, state));
    }
