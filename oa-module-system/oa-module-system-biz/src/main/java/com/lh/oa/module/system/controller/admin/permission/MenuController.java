package com.lh.oa.module.system.controller.admin.permission;

import com.lh.oa.framework.common.enums.CommonStatusEnum;
import com.lh.oa.framework.common.pojo.CommonResult;
import com.lh.oa.module.system.controller.admin.permission.vo.menu.*;
import com.lh.oa.module.system.controller.admin.permission.vo.menu.*;
...
public class MenuController {
    ...
    public CommonResult<List<MenuRespVO>> getMenuList(MenuListReqVO reqVO) {
        ...
        List<MenuRespVO> menuRespVOS = MenuConvert.INSTANCE.convertList(list);
        return success(buildMenuTree(menuRespVOS));
    }
    ...
    public static List<MenuRespVO> buildMenuTree(List<MenuRespVO> menuList) {
        // 使用一个 map 来存储菜单 ID 与对应菜单对象的映射关系，方便后续构建树形结构
        Map<Long, MenuRespVO> menuMap = new HashMap<>();
        ...
        for (MenuRespVO menu : menuList) {
            if (menu.getParentId() == 0) {
                ...
                // 非根节点，将菜单添加到父菜单的子菜单列表中
                MenuRespVO parentMenu = menuMap.get(menu.getParentId());
                if (parentMenu != null) {
