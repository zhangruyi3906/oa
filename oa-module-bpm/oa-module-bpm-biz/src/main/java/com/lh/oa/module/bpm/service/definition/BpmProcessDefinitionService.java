...
public interface BpmProcessDefinitionService {
     ...
     * @return 流程定义列表
     */
    List<BpmProcessTypeGroupRespVO> getProcessDefinitionList(BpmProcessDefinitionListReqVO listReqVO);
     ...
     * @return
     */
    List<BpmProcessDefinitionRespVO> getProcessDefinitionById(String definitionId);
    ...
    List<BpmProcessDefinitionExtDO> getByDefinitionIds(Set<String> procDefinitionIds);
}
