...
@Component
@Slf4j
public class BpmTaskAssignParticipantLeaderX2Script extends BpmTaskAssignLeaderAbstractScript {
    ...
    public Set<Long> calculateTaskCandidateUsers(DelegateExecution execution) {
        ...
        return getPartyAssigneeUser(party, 2);
    }

    @Override
    public BpmTaskRuleScriptEnum getEnum() {
        return BpmTaskRuleScriptEnum.PARTICIPANT_LEADER_X2;
    }
