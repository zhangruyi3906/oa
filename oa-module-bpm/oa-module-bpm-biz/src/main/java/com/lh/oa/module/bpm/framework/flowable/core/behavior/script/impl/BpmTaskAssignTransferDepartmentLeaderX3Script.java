...
@Component
@Slf4j
public class BpmTaskAssignTransferDepartmentLeaderX3Script extends BpmTaskAssignLeaderAbstractScript {
    ...
    public Set<Long> calculateTaskCandidateUsers(DelegateExecution execution) {
        ...
        return getTransferDeptAssigneeUser(transferDept, 3);
    }

    @Override
    public BpmTaskRuleScriptEnum getEnum() {
        return BpmTaskRuleScriptEnum.TRANSFER_DEPARTMENT_LEADER_X3;
    }
