package com.lh.oa.gateway.filter.security;

import cn.hutool.core.util.StrUtil;
import com.lh.oa.framework.common.core.KeyValue;
import com.lh.oa.framework.common.pojo.CommonResult;
import com.lh.oa.framework.common.util.cache.CacheUtils;
import com.lh.oa.framework.common.util.json.JsonUtils;
import com.lh.oa.gateway.util.SecurityFrameworkUtils;
import com.lh.oa.gateway.util.WebFrameworkUtils;
...
public class TokenAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private LoginUser buildUser(String body) {
        ...
        if (result.isError()) {
            ...
            if (Objects.equals(result.getStatus(), HttpStatus.UNAUTHORIZED.value())) {
