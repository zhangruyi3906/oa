package com.lh.oa.framework.operatelog.core.aop;
...
import com.lh.oa.framework.operatelog.core.enums.OperateTypeEnum;
import com.lh.oa.framework.operatelog.core.service.OperateLog;
import com.lh.oa.framework.operatelog.core.service.OperateLogFrameworkService;
import com.lh.oa.framework.web.core.util.WebFrameworkUtils;
...
import static com.lh.oa.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.lh.oa.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.lh.oa.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.lh.oa.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.lh.oa.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.lh.oa.framework.operatelog.core.annotations.OperateLog operateLog,
    ...
    private static void fillMethodFields(OperateLog operateLogObj,
        ...
        if (result instanceof CommonResult) {
            ...
            operateLogObj.setResultCode(commonResult.getStatus());
