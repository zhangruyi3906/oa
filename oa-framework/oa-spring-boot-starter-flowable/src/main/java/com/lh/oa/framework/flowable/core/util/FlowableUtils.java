package com.lh.oa.framework.flowable.core.util;
...
public class FlowableUtils {
    ...
    public static <T extends FlowElement> List<T> getBpmnModelElements(BpmnModel model, Class<T> clazz) {
        ...
        model.getProcesses().forEach(process -> {
            List<FlowElement> collect = process.getFlowElementMap().values().stream().collect(Collectors.toList());
            collect.forEach(flowElement -> {
