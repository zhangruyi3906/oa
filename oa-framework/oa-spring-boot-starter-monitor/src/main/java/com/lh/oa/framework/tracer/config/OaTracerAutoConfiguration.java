package com.lh.oa.framework.tracer.config;

import com.lh.oa.framework.common.enums.WebFilterOrderEnum;
import com.lh.oa.framework.tracer.core.aop.BizTraceAspect;
import com.lh.oa.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "oa.tracer", value = "enable", matchIfMissing = true)
public class OaTracerAutoConfiguration {
