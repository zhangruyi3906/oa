package com.lh.oa.framework.swagger.config;
...
import static com.lh.oa.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class OaSwaggerAutoConfiguration {
