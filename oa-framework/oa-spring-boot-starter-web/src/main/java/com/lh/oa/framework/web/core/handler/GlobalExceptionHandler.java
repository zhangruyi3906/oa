package com.lh.oa.framework.web.core.handler;

import cn.hutool.core.exceptions.ExceptionUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.extra.servlet.ServletUtil;
import com.lh.oa.framework.apilog.core.service.ApiErrorLog;
...
//    }
    ...
    public CommonResult<?> accessDeniedExceptionHandler(HttpServletRequest req, AccessDeniedException ex) {
        log.warn("[accessDeniedExceptionHandler][userId({}) 无法访问 url({})] error {}", WebFrameworkUtils.getLoginUserId(req),
                req.getRequestURL(), ex.getLocalizedMessage());
    ...
    public CommonResult<?> serviceExceptionHandler(ServiceException ex) {
        log.info("[serviceExceptionHandler] status: {}, error: {}" , ex.getCode(), ex.getLocalizedMessage());
        return CommonResult.error(ex.getCode(), ex.getMessage());
    }

    @ExceptionHandler(value = BusinessException.class)
    public CommonResult<?> businessExceptionHandler(BusinessException ex) {
        log.info("[businessExceptionHandler] error: {}", ex.getLocalizedMessage());
